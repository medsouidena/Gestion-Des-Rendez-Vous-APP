            ...
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-md-12">
                    <div class="authincation-content">
                        <div class="row">
                            <div class="col-xl-5">
                                <img src="images/logoMask.png" alt="" style="width: 500px;height: 550px;">
                            </div>
                            <div class="col-xl-7">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<img src="images/logo_87.png" alt="" style="width: 100px;height: 100px;">
									</div>
                                    ...
                                    <form action="code php/Compte_connexion.php" method="POST">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-block" style="background-color: #FF5733; color: aliceblue;"  name="login" value="login">CONNEXION</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
